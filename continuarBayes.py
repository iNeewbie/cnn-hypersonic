...
optimizer= joblib.load('optimizer_results.pkl')
...
# Salvar o estado atualizado do otimizador
joblib.dump(optimizer, 'optimizer_results.pkl')

# Resultados
print(optimizer.max)
print(f"Otimização adicional demorou {(opt_time_end - opt_time_start) / 60:.2f} minutos")

# Atualizar o arquivo CSV com os novos resultados
